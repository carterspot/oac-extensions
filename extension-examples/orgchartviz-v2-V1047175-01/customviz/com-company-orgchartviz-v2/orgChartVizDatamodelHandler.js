define(['obitech-framework/jsx',
        ...
        function(jsx, 
                 ...
                 vdm) {
   "use strict";
   var orgChartVizDataModelHandler = {};
    ...
    * @memberof module:com-company-orgchartviz-v2/OrgChartVizDataModelHandler#
    * @extends module:obitech-viz/vizDataModelHandlerBase#VisualizationHandlerBase
    */
   function OrgChartVizDataModelHandler(oConfig, sId, sDisplayName, sOrigin, sVersion)
   {
      OrgChartVizDataModelHandler.baseConstructor.call(this, oConfig, sId, sDisplayName, sOrigin, sVersion);
   }
   jsx.extend(OrgChartVizDataModelHandler, genericDataModelHandler.GenericDataModelHandler);
   orgChartVizDataModelHandler.OrgChartVizDataModelHandler = OrgChartVizDataModelHandler;

   /**
    * @returns module:obitech-report/vizdatamodelsmanager#Mapper
    */
   OrgChartVizDataModelHandler.prototype.getLogicalMapper = function () {
    ...
    *@param {Object} config
    */
   orgChartVizDataModelHandler.getHandler = function(extensionPointName, config) {
      return new OrgChartVizDataModelHandler(config, extensionPointName);
   };

   return orgChartVizDataModelHandler;
});
